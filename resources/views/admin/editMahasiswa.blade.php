...
<div class="container px-6 mx-auto grid">
            ...
            <form action="{{ route('mahasiswa.update',$mahasiswa->id)}}" method="PUT" enctype="multipart/form-data">
            @csrf
                <div
                ...
                >
                    <div class="col-span-6 sm:col-span-4">
                        <label for="nama" class="block text-sm">
                            ...
                            <input 
                            type="text" name="nama" id="nama" value="{{ (isset($mahasiswa)) ?$mahasiswa->nama : old('nama')}}"
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        <label for="nim" class="block text-sm">
                            ...
                            <input 
                            type="text" name="nim" id="nim" value="{{ (isset($mahasiswa)) ?$mahasiswa->nim : old('nim')}}"
                ...
                <label for="jurusan_id" class="block mt-4 text-sm">
                    ...
                    <select
                        name="jurusan_id" id="jurusan_id" value="{{ (isset($mahasiswa)) ?$mahasiswa->jurusan : old('jurusan')}}"
                ...
                <label for="prodi_id" class="block mt-4 text-sm">
                    ...
                    <select
                        name="prodi_id" id="prodi_id" selected="{{ (isset($mahasiswa)) ? $mahasiswa->prodi : old('prodi')}}"
                    class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                    >
                    @foreach ($prodi as $ps)
                ...
                <div class="col-span-6 sm:col-span-4">
                        <label for="email" class="block text-sm">
                            ...
                            <input 
                            type="email" name="email" id="email" value="{{ (isset($mahasiswa)) ?$mahasiswa->email : old('email')}}"
