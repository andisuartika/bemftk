                          ...
                          Kegiatan Baru
                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" type="text" name="time_start" id="time_start" autocomplete="time_start" value="{{ (isset($kegiatan)) ?$kegiatan->time_start: old('time_start')}}" class="@error('time_start') border-red-600 @enderror mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        <span class="text-xs text-red-600 dark:text-red-400">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" type="text" name="time_end" id="time_end" autocomplete="time_end" value="{{ (isset($kegiatan)) ?$kegiatan->time_end: old('time_end')}}" class="@error('time_end') border-red-600 @enderror mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        <span class="text-xs text-red-600 dark:text-red-400">
